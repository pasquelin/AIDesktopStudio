...
export const PROJECT_FORMAT_SCENARIOS: readonly Scenario[] = [
  {
    name: '71.1 lists project input maps',
  ...
  {
    name: '71.6 writes one animation graph',
  ...
  {
    name: '71.7 measures animation retargeting',
