...
export const MEMORY_WORTH: Record<ActionName, MemoryRule> = {
  ...
  'actions.find': null,
  'target.select': null,
  'optimization.analyze': null,
  'optimization.selection': null,
  'optimization.world': null,
  'optimization.report': null,
  'optimization.clearCache': null,
  'optimization.exclude': null,
  'optimization.setMode': null,
  'studio.state': null,
  'documents.list': null,
  'document.open': null,
  ...
  'canvas.state': null,
  'canvas.setDocumentProperties': null,
  'img.pin': null,
  'canvas.resize': null,
  ...
  'skybox.state': null,
  'skybox.setViewportOptions': null,
  ...
  'model.setMaterialDocument': null,
  'model.setBaseColorImage': null,
  'camera.addShot': null,
  ...
  'post.duplicate': null,
  'post.reset': null,
  'post.addKeyframe': null,
  'post.removeKeyframe': null,
  ...
  'animation.reopenMotion': null,
  'inputMaps.list': null,
  'inputMap.read': null,
  'inputMap.write': null,
  'animationGraphs.list': null,
  'animationGraph.read': null,
  'animationGraph.write': null,
  'animation.retargetStatus': null,
