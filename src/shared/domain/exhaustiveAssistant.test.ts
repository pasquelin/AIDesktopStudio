...
const ALL_ACTIONS: Record<ActionName, true> = {
  ...
  'canvas.state': true,
  'canvas.setDocumentProperties': true,
  'img.pin': true,
  'canvas.resize': true,
  ...
  'animation.reopenMotion': true,
  'inputMaps.list': true,
  'inputMap.read': true,
  'inputMap.write': true,
  'animationGraphs.list': true,
  'animationGraph.read': true,
  'animationGraph.write': true,
  'animation.retargetStatus': true,
